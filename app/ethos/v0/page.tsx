        ...
        <div className="max-w-2xl space-y-8">
          <div>
            ...
            <p className="text-fd-muted-foreground leading-relaxed">
              This isn't just his story. It's happening everywhere. A leather bag maker spends her days crafting products customers love, but most of what she earns goes to the platform—not for infrastructure she uses, but simply for being discovered. Over years, the fees compound into fortunes extracted just for the privilege of reaching customers.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-fd-muted-foreground leading-relaxed mb-4">
              Traditional marketplaces charge substantial fees per transaction because they built massive infrastructure—payment
            ...
            <p className="text-fd-muted-foreground leading-relaxed">
              ...
              own account. We don't touch it. We don't see it. We don't take a cut. Zero transaction fees.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-fd-muted-foreground leading-relaxed mb-4">
              Long-term, directory operators could charge stores a flat monthly fee for inclusion, or operate
              on tips from customers who value the curation. The point is: the revenue model doesn't require
              transaction fees because the infrastructure doesn't require overhead.
            </p>
            <p className="text-fd-muted-foreground leading-relaxed mb-4">
              <strong>"What stops you from becoming the next Amazon?"</strong>
            </p>
            <p className="text-fd-muted-foreground leading-relaxed mb-4">
              The code is open source. If we started charging excessive fees or playing algorithmic favorites,
              anyone could fork and launch a competing directory in an afternoon. Stores aren't locked in. They
              don't lose reviews or rankings by connecting to a different directory. The power is structural,
          ...
          <div>
            ...
            <p className="text-fd-muted-foreground leading-relaxed mb-4">
              ...
              integrations. No lock-in. You keep your customer data, process payments on your terms, fulfill
              orders your way. As new curated directories appear for different niches and regions, you're
